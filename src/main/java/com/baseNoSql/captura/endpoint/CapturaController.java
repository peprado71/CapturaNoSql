package com.baseNoSql.captura.endpoint;
...
import com.baseNoSql.captura.repository.CapturaRepository;
...
import com.fasterxml.jackson.databind.ObjectMapper;
	...
	public class CapturaController {
	  ...
	  public ResponseEntity<Captura> getCapturaById(@PathVariable("id") String id) {
	  ...
	  public ResponseEntity<Captura> updateCaptura(@PathVariable("id") String id, @RequestBody Captura captura) {
	    Optional<Captura> capturaData = capturaRepository.findById(id);
	  ...
	  public ResponseEntity<HttpStatus> deleteCaptura(@PathVariable("id") String id) {
	    try {
